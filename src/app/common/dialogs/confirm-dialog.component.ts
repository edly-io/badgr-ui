			...
			<div class="dialog-x-box o-container">
				<div class="u-padding-all3x">
					<div class="l-flex l-flex-justifybetween u-margin-bottom2x">
						<h2 class="u-text-body-bold-caps font-family-plex-blue">
							{{ options.dialogTitle }}
						</h2>
					...
					<p class="u-text-body font-family-plex-blue" [innerHTML]="options.dialogBody"></p>

					<div class="l-flex l-flex-1x l-flex-justifyend u-margin-top2x gap-2">
						<button [disabled]="options.disableConfirm" class="primary-button" (click)="resolveDialog()">
							{{ options.resolveButtonLabel }}
						</button>
						<button *ngIf="options.showRejectButton" class="new-button-secondary" (click)="rejectDialog()">
